...
<div id="mainarea">
<div class="mcf"></div>
<div align="center" class="heading_report">KD STOCK LEDGER</div>
...
<table width="100%">
 <tr>
		...
		<span id="kdspan">
			<select class="dsrname" name="kdcode" id="kdcode" onChange="getKDstockledger();"> <!-- multiple -->
		  ...
		  <table border="1" width="100%">
			<thead>
			  <tr>
				...
				<th align="center" style="width:10%">Transaction</th>
				<th align="center" style="width:10%">Tran Number</th>
				<th align="center" style="width:10%">Party</th>
...
<div class="mcf"></div> 
	  <div id="errormsgkdstockled" style="display:none;"><h3 align="center" class="myalignkdstockled"></h3><button id="closebutton">Close</button></div>
