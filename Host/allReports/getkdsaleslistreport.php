	...
	if($k != 0) {
		...
		?>	
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> KD Total<strong></td>
		  <td >&nbsp;
		  <table width="100%"><tr><td><?php echo $target_units_kd; ?></td><td><?php echo $target_naira_kd; ?></td></tr></table>
		  </td>	
		  <td>&nbsp;
		  <table width="100%"><tr><td><?php echo $SUM_SQ_kd; ?></td><td><?php echo $VALUE_NAIRA_kd; ?></td></tr></table>
		  </td>	
		  <td>&nbsp;
		  <table width="100%"><tr><td><?php echo $diff_units_kd; ?></td><td><?php echo $diff_naira_kd; ?></td></tr></table>
		  </td>
	 </tr>
