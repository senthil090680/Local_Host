...
?>
  <table border="1" width="100%" style="border-collapse:collapse;" class="tablecls">
	<thead class="theadcls">
	  <tr>
		<th align="center" >KD Name</th>
		<th align="center" >SR Name</th>
		<th align="center" >ASM Name</th>
		<th align="center" >RSM Name</th>
		<th align="center" >Total Customers Per Plan (A)</th>
		<th align="center" >Total Customers Visited Once (B)</th>
		<th align="center" >Coverage %(B/A)
			 <table  width="100%"><tr><td>Target</td><td>Actual</td></tr></table>
		</th>
		<th align="center" >Total Customers Sold Atleast Once(C)</th>
		 <th align="center" style="width:10%">Effective Coverage%(C/A)
		<table  width="100%"><tr><td>Target</td><td>Actual</td></tr></table>
		</th>
		 <th align="center" >Total Including Repeat Cus Visits
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
		  ...
		  <td align="center">
			  <table width="100%" border="0">
				<tr>
					<td><?php echo $total_cov_tgt; ?></td>
					<td><?php echo round($total_cov_act/$qwe); ?></td>
				</tr>
			  </table>
		  </td>	
		  <td align="right"><?php echo $total_sales_once; ?></td>	
		  <td align="center">
			<table width="100%" border="0">
				<tr>
					<td><?php echo $total_eff_tgt; ?></td>
					<td><?php echo round($total_eff_act/$qwe); ?></td>
				</tr>
			</table>
		  </td>	
		  <td align="center">
			<table  width="100%" border="0">
				<tr>
					<td><?php echo $total_vists; ?></td>
					<td><?php echo number_format(trim($total_sales)); ?></td>
					<td><?php echo round($total_prod_cov/$qwe); ?></td>
				</tr>
			</table>
		  </td>
	 </tr>
...
<tr>
	 <td <?php if($reportby == 'KD_Name') { ?> style="background-color:#31859C;" <?php } ?> ><?php echo ucwords(strtolower($SearchVal[KD_Name])); ?></td>
	  ...
	  <td align="right"><?php echo $SearchVal[TOTALCUS]; ?></td>	
	  <td align="right"><?php echo $SearchVal[EFF_CNT]; ?></td>	
	  <td align="center">
		<table width="100%" border="0">
			<tr>
				<td><?php echo $SearchVal[COV_TGT]; ?></td>
				<td><?php echo $SearchVal[COVACT]; ?></td>
			</tr>
		</table>
	  </td>
	  <td align="right"><?php echo $SearchVal[PRO_CNT]; ?></td>
	  <td align="center">
		<table width="100%" border="0">
			<tr>
				<td><?php echo $SearchVal[EFF_TGT]; ?></td>
				<td><?php echo $SearchVal[EFFACT]; ?></td>
			</tr>
		</table>
	 </td>
	 <td align="center">
		<table width="100%" border="0">
			<tr>
				<td><?php echo $SearchVal[VISIT_CNT]; ?></td>
				<td><?php echo $SearchVal[INVOICE_CNT]; ?></td>
				<td><?php echo $SearchVal[PROACT]; ?></td>
			</tr>
		</table>
	 </td>
 </tr>
 ...
 ?>
  <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Sub Total<strong></td>
		  ...
		  <td align="right"><?php echo number_format(trim($total_sales_once)); ?></td>	
		  <td align="center">
			<table width="100%" border="0">
				<tr>
					<td><?php echo $total_eff_tgt; ?></td>
  ...
  <tr>
		 ...
		 //echo $checkfor ."==" .$checkoutfor."<br>"; ?> Grand Total<strong></td>
		  ...
		  <td align="center">
			<table width="100%" border="0">
				<tr>
					<td><?php echo $tot_cov_tgt; ?></td>
					<td><?php echo round($tot_cov_act/$cwe); ?></td>
				</tr>
			</table>
		  </td>	
		  <td align="right"><?php echo $tot_sales_once; ?></td>	
		  <td align="center">
			<table width="100%" border="0">
				<tr>
					<td><?php echo $tot_eff_tgt; ?></td>
					<td><?php echo round($tot_eff_act/$cwe); ?></td>
				</tr>
			</table>
		  </td>	
		  <td align="center">
			<table  width="100%" border="0">
				<tr>
					<td><?php echo $tot_vists; ?></td>
					<td><?php echo number_format(trim($tot_sales)); ?></td>
					<td><?php echo round($tot_prod_cov/$cwe); ?></td>
				</tr>
			</table>
		  </td>
	 </tr>
