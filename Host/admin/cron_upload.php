...
$path=$_SERVER['DOCUMENT_ROOT']."/meena/Host_new/UploadtoCP/";
$tables = array("device_master.csv","route_master.csv","vehicle_master.csv","dealer_sales_rep_master.csv","dealer_sales_rep_master.csv","customer_master.csv");
