...
<div id="containerBD">
<input type="button" name="kdproduct" value="Add SchemeProduct" class="buttonsbig" onclick="window.location='productscheme.php'">
		...
		<thead>
		<tr>
		<th nowrap="nowrap">Scheme_Description</th>
