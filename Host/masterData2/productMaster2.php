...
<table>
  ...
  <tr height="28px">  
   ...
   <td colspan="5"><input type="text" name="Product_description2" size="65" maxlength="50" value="<?php echo $Product_description2; ?>"  autocomplete='off'/></td>
   <td>&nbsp;</td>
   <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr height="28px">  
   <td class="align">Batch Flag</td> 
    ...
    <td><input type="text" name="Effective_date"  class="datepicker" size="10" value="<?php if($_REQUEST['id']!=''){ echo date("d-m-Y",strtotime($Effective_date));}?>"  autocomplete="off" /></td>
    </tr>
...
<div id="containerpr">
 ...
 $pm_sql="select e.*,f.* from product as e, price_master as f where e.Product_code='$Product_code' AND f.Product_code='$id'";
        ...
        <td align="right"  width='100'><a href="productMaster.php?id=<?php echo $fetch['id'];?>"><img src="../images/user_edit.png" alt="" title="" width="11" height="11"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
