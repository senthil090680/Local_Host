...
if($submit=='Save')
{
			...
			{				
				...
				if($row=='0') {
			    mysql_query("INSERT INTO customertype_product(customer_type,UOM1,Product_code,Product_description1)VALUES('$customer_type','$UOM1','$Product_code','$Product_description1[$j]')");
