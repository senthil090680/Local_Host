...
$sql =("UPDATE category3 SET 
       ...
       WHERE id = $id");
mysql_query( $sql);
header("location:customercategory3.php?no=2");
}
else{
header("location:customercategory3.php?no=18");
}
}
}
...
$sel_query=mysql_query($sel);
        ...
        mysql_query( $sql);
        header("location:customercategory3.php?no=1");
		}
		else {
		header("location:customercategory3.php?no=18");
	}
...
<div id="container">
		...
		if($cnt=='1'){
        header("location:customercategory3.php?no=34"); 
		  }
		}
		if($_GET['delID']!=''){
        ...
        header("location:customercategory3.php?no=3");
		}
		 }
		...
		$var = @$_GET['category3'] ;
        $trimmed = trim($var);		
	    $qry="SELECT * FROM `category3` where category3 like '%".$trimmed."%' order by id asc";
		}
		else
		{ 
		$qry="SELECT * FROM `category3` order by id asc";  
		}
		...
		<td align="right">
        <a href="customercategory3.php?id=<?php echo $fetch['id'];?>"><img src="../images/user_edit.png" alt="" title="" width="11" height="11"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="customercategory3.php?id=<?php echo $fetch['id'];?>&delID=<?php echo $fetch['id'];?>"><img src="../images/trash.png" alt="" title="" width="11" height="11" /></a>
        </td>
        </tr>
		<?php $c++; $cc++; }		 
