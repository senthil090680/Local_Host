...
<table width="100%" align="center">
  <tr>
    <td width="50">KD Category*<input type="hidden" name="update_date" value="" autocomplete="off" id="hdnData" readonly></td>
    <td width="121">
...
<!--	<td width="50" class="align">Product Type</td>
		<td width="192">
		<select name="product_type" id="user"  autocomplete="off" value="" ONCHANGE="location = this.options[this.selectedIndex].value;">
		<option value="">--- Select ---</option>
...
<?php
       ...
       <!-- <th>Mod</th>-->
		...
		<input type="checkbox" id="prd_code_<?php echo $cc; ?>" onClick="inputcheck(<?php echo $cc; ?>);" name="Product_code[]" value="<?php echo $fetch['Product_code'];?>" class="Product_code" <?php if($_GET['no']=='1'||$_GET['data']!=''){echo $fetch['Status'];}else{ echo 'UnChecked';}?>></td>
