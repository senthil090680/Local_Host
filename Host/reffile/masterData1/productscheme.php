...
<form action="productschemeAction.php" method="post" >
<table>
  <tr height="28px">
    <td>KD Category
    <td>
    <select name="Kd_category"  class="Kd_category" id="Kd_category"  autocomplete="off" style="width:100%;" value="" >
...
<td class="align">Effective To</td>
  ...
  <tr height="28px">
    <td>Quantity</td>
    <td><input type="text"  name="Quantity" class="Quantity"  value="<?php echo $fet_scheme['Quantity'];?>" autocomplete="off" size="5" maxlength="20">
	</td> 
	...
	<tr><td>UOM</td><td>Pieces</td>
    <td class="align show_pdt">Add Product</td>
	<td class="show_pdt">    
    ...
    <tr>
     <td></td>
     <td></td>
      <td class="align show_pdt">Scheme Quant</td>
      <td><input type="text"  name="scheme_pro_quant" class="scheme_pro_quant"  value="<?php echo $fet_scheme['scheme_pro_quant'];?>" autocomplete="off" size="5" maxlength="20">
      </tr>
