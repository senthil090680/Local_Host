...
$id=$_GET['id'];
$list=mysql_query("select * from uom where id= '$id'"); 
...
<table>
  <tr height="50px">
     ...
     <td><input type="text" class="required" name="UOM_code" id="UOM_code" size="10" value="pcs" readonly="readonly"/></td>
   </tr>
   
  <tr>
    <td  class="align">UOM Description*</td>
    <td><input type="text" class="required" name="UOM_description" id="UOM_description" size="10" value="Pieces" readonly="readonly"/></td>
   </tr>
...
<div id="container">
	    ...
	    <td><?php echo $fetch['UOM_description'];?></td>
       	<td align="right">
        <a href="#uomMaster.php?id=<?php echo $fetch['id'];?>"><img src="../images/user_edit.png" alt="" title="" width="11" height="11"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="#uomMaster.php?id=<?php echo $fetch['id'];?>"><img src="../images/trash.png" alt="" title="" width="11" height="11" /></a>
        </td>
        </tr>
		<?php $c++; $cc++; }		 
