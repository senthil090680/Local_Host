...
if($_GET["Product_code"]!='')
{
		...
		if($row2=='0')
		{
			...
			//echo "LP"; exit;
			$delete="delete from `price_master` WHERE `Product_code` = ".$_GET['Product_code']; 
...
if($submit=='Save')
{
		...
		for($j=0;$j<$cnt;$j++){
				...
				if($row=='0') {
				//echo "INSERT INTO price_master(KD_Code,Kd_Category,UOM1,Product_code,Price,Effective_date,Status_price_master)VALUES('','$Kd_Category','$UOM1','$Product_code','$Price','$Effective_date','Checked'"; exit;
