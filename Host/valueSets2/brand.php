...
<table>
  <tr height="60px">
    ...
    <td><input type="text" name="brand" value="<?php echo $brand; ?>" autocomplete='off' maxlength="20"/></td>
   </tr>
...
<input type="text" name="brand" value="<?php $_GET['brand']; ?>" autocomplete='off' placeholder='Search By Cate1'/>
