						...
						<td align="right" style="font-weight:bold">
							<table width="100%" style='table-layout:fixed;'>
								<tr>
										...
										<td align='right' style='width:30px;'><?php if($prod_tgt_act_percent != '') { echo number_format($prod_tgt_act_percent); } else { echo '0'; } ?></td>
									</tr>
							</table>
						</td>
						...
						<td align="right" style="font-weight:bold">
							<table width="100%" style='table-layout:fixed;'>
								<tr>
										...
										<td align='right' style='width:30px;'><?php if($eff_tgt_act_percent != '') { echo number_format($eff_tgt_act_percent); } else { echo '0'; } ?></td>
									</tr>
							</table>
						</td>
					</tr>
...
<!-- Left End  -->
  ...
  <div style="padding-left:450px;"><a href="javascript:void(0);" onClick="getdevdash()">1</a>&nbsp;&nbsp;&nbsp; 2<br/><br/></div>
  <?php if(!empty($num_fir) || !empty($num_sec) || !empty($num_third)) { ?>
	 <div style="padding-left:410px;">
	 	 
	 <span ><input type="button" name="kdproduct" value="Print" class="buttons" onclick="print_pages('printdashmetajax');" ></span>&nbsp;&nbsp;&nbsp;<span ><input type="button" value="Close" class="buttons" onclick="window.location='../include/empty.php'"></span></div>
	<form id="printdashmetajax" target="_blank" action="printdashmetajax.php" method="post">
